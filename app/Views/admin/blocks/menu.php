<aside class="page-sidebar">
    <div class="page-logo">
        <a href="#" class="page-logo-link press-scale-down d-flex align-items-center">
            <img src="/public/admin/img/logo.png" alt="MFS 3.0 AdminPanel">
    ...
    <nav id="js-primary-nav" class="primary-nav" role="navigation">
        ...
        <div class="info-card">
            ...
            <img src="/public/admin/img/card-backgrounds/cover-2-lg.png" class="cover" alt="cover">
        ...
        <ul id="js-nav-menu" class="nav-menu">
            ...
            <li>
                <a href="#" title="Реклама">
                    <i class="fal fa-window"></i>
                    <span class="nav-link-text" data-i18n="nav.ui_components">Реклама</span>
                </a>
                <ul>
                    <li>
                    ...
                    <li>
                        <a href="ui_accordion.html" title="Автосерфинг">
                            <span class="nav-link-text">Автосерфинг</span>
                        </a>
                    </li>
                    <li>
                        <a href="ui_badges.html" title="Письма">
                            <span class="nav-link-text">Письма</span>
                        </a>
                    </li>
                    <li>
                        <a href="ui_breadcrumbs.html" title="Задания">
                            <span class="nav-link-text">Задания</span>
                        </a>
                    </li>
                    <li>
                        <a href="ui_buttons.html" title="Тесты">
                            <span class="nav-link-text">Тесты</span>
                        </a>
                    </li>
                    <li>
                        <a href="ui_button_group.html" title="Банеры">
                            <span class="nav-link-text">Банеры</span>
                        </a>
                    </li>
                    <li>
                        <a href="ui_cards.html" title="Статические ссылки">
                            <span class="nav-link-text">Статические ссылки</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" title="FontAwesome"
                           data-filter-tags="font icons fontawesome">
                                    <span class="nav-link-text"
                                          data-i18n="nav.font_icons_fontawesome">FontAwesome Pro</span>
                        </a>
                        <ul>
                            <li>
                    ...
                    <li>
                        <a href="javascript:void(0);" title="NextGen Icons"
                           data-filter-tags="font icons nextgen icons">
                                    <span class="nav-link-text"
                                          data-i18n="nav.font_icons_nextgen_icons">NextGen Icons</span>
                        </a>
                        <ul>
                            <li>
                    ...
                    <li>
                        <a href="javascript:void(0);" title="Stack Icons"
                           data-filter-tags="font icons stack icons">
                                    <span class="nav-link-text"
                                          data-i18n="nav.font_icons_stack_icons">Stack Icons</span>
                        </a>
                        <ul>
                            <li>
                    ...
                    <li class="active">
                        <a href="form_basic_inputs.html" title="Basic Inputs"
                           data-filter-tags="form stuff basic inputs">
                                    <span class="nav-link-text"
                                          data-i18n="nav.form_stuff_basic_inputs">Basic Inputs</span>
                        </a>
                    </li>
                    <li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li>
                        <a href="plugin_smartpanels.html" title="SmartPanels"
                    ...
                    <li>
                        <a href="plugin_bootbox.html" title="BootBox"
                    ...
                    <li>
                        <a href="plugin_slimscroll.html" title="Slimscroll"
                    ...
                    <li>
                        <a href="plugin_navigation.html" title="Navigation"
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="page_login-alt.html" title="Login Alt"
                    ...
                    <li>
                        <a href="page_search.html" title="Search Results"
                           data-filter-tags="pages search results">
                                    <span class="nav-link-text"
                                          data-i18n="nav.pages_search_results">Search Results</span>
                        </a>
                    </li>
                </ul>
            </li>
